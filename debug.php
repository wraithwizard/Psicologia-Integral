...
$paypalPrice = 1000.00;
$IDCLIENT = "";
$PAYPALS = $_SERVER["PAYPAL_ID_CLIENT"];
?>
...
<body>
    ...
    <!-- paypal -->
    <script src="https://www.paypal.com/sdk/js?client-id=<?php echo json_encode($PAYPALS); ?>&currency=MXN" data-sdk-integration-source="integrationbuilder_sc"></script>
    <script> 
        paypal.Buttons({
        style: {
            shape: "pill",
