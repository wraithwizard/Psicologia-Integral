        ...
        <div class="main-div">
            <div class="app">    
                <div class="form-login">
                    <form class="login" id="loginID" action="../../models/recuperar-pw-enviar.php" method="POST" onsubmit="return submitUserForm();">
                        <h2>Recuperar contraseña</h2>        
                        <p class="forgot-pw recuperar-pw-txt">Escribe tu nueva constraseña a continuación</p>
