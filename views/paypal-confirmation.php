...
if (isset($time) && isset($fecha) && isset($serviceId) && isset($email) && isset($modalidad)) {
...
<body>
    ...
    <main>
        ...
        <div class="main-div">
                ...
                <p class="main-text__comprado"><br>¡Gracias por tu compra! Te hemos enviado un correo electrónico con los detalles.</p><br>
            </div>
        </div>                 
    </main>
